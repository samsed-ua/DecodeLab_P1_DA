...
**Pipeline:** `Project 1 (Cleaning) → Project 2 (EDA) → Project 3 (SQL Analysis) → Project 4 (Visualization)`
...
| | |
|---|---|
| **Raw input** | `Dataset for Data Analytics (1).csv` |
...
**Notebook:** `Data_Analytics_Project_3.ipynb`
...
**Notebook:** `Data_Analytics_Project_4.ipynb`
...
1. Open each notebook in Jupyter, in order (1 → 2 → 3 → 4)
...
Internship project completed as part of the **DecodeLabs Data Analytics Internship Program**.
